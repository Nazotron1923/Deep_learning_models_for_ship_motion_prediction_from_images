...
parser.add_argument('-o', '--origin_file', help='Original file', default="Pre/results/train_CNN_LSTM_encoder_decoder_images_PR_using_10_s_to_predict_12_s_lr_0.0001_2019-07-05 00:36/labels/originCNN_LSTM_encoder_decoder_images_PR_use_10_s_to_predict_10:24_lr_0.0001.json", type=str)
parser.add_argument('-p', '--prediction_file', help='Predictin file', default="Pre/results/train_CNN_LSTM_encoder_decoder_images_PR_using_10_s_to_predict_12_s_lr_0.0001_2019-07-05 00:36/labels/predCNN_LSTM_encoder_decoder_images_PR_use_10_s_to_predict_10:24_lr_0.0001.json", type=str)
