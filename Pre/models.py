...
class CNN_LSTM_encoder_decoder_images(nn.Module):
    def __init__(self,h_dim=2688, z_dim=1024, encoder_input_size = 4096, encoder_hidden_size = 1024, decoder_hidden_size = 1024,  output_size = 20):
...
class CNN_LSTM_decoder_images_PR(nn.Module):
    def __init__(self,h_dim=2688, z_dim=1024, decoder_input_size = 1000, decoder_hidden_size = 1000,  output_size = 20, drop_par = 0.2):
...
class CNN_PR_FC (nn.Module):
    def __init__(self, cnn_fc_size = 1024, num_output=20, h_dim=2688, z_dim=1024):
    ...
    def forward(self, x, p_and_roll, num_images, cuda):
        ...
        features = [self.encode(x[:,i,:,:,:], cuda) for i in range(num_images-1, -1, -1)]
...
class CNN_LSTM_image_encoder_PR_encoder_decoder(nn.Module):
    def __init__(self,h_dim=2688, z_dim=1024, im_encoder_input_size = 4096, pr_encoder_input_size = 20 , im_encoder_hidden_size = 128, pr_encoder_hidden_size = 128, decoder_hidden_size = 256,  output_size = 20):
...
class CNN_stack_FC_first(nn.Module):
    def __init__(self, num_channel = 3,  cnn_fc_size = 1024, num_output=20):
