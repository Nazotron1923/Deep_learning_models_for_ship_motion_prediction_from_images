...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--InputFolder', help='Input folders names prefix', default="./test_1_episode_", type=str)
    parser.add_argument('-o', '--OutputFolder', help='Output folder name prefix', default='./test_1_episode_', type=str)
    ...
    parser.add_argument('-t', '--TimeGaps', help='List of Time gaps', default=[1, 2, 5,10,15,20], type=list)  				# to test more gaps
